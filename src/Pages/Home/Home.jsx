    ...
    <div  className='z-[100]'>
      ...
      <div className='mt-auto mb-auto '>
          ...
          <div className='ml-auto mr-auto w-fit mt-4'>
            <button className='bg-black rounded-3xl text-white font-[500] p-2 ml-auto mr-auto flex gap-2 items-center  ' onClick={()=>{window.open('https://drive.google.com/file/d/1riUs7rbpc87Vq4KsIA1dDw8mf3UpUvCl/view?usp=sharing' , '_blank')}}>
                Download Cv
